...
export const Footer = ()=>{
    return(
        <footer className=" bg-[#041925] py-9 text-white p-5">
            <div className="container mx-auto">
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-5">
                    <div className="col-span-2">
                        ...
                        <p className=' text-[17px]'> Música, radio y podcasts, todo gratis.</p>
                        <p className=' text-[17px]'>Escucha en Línea o descarga la aplicación MI Emisoras</p>
                    </div>
                ...
                <div className="flex flex-col md:flex-row md:justify-end md:items-center pt-8">
                    <ul className="flex mr-7 md:w-[41.5%] w-ful mb-4">
                        <li className=" mr-3 text-sm"><a href="#">Privacidad</a></li>
                        <li className=" mr-3 text-sm"><a href="#">Términos</a></li>
                        <li className=" mr-3 text-sm"><a href="#">Mapa del sitio</a></li>
                    </ul>
                ...
                <div className="flex justify-center md:justify-start items-center pt-6">
                    <p className='text-sm text-center'>2023 Mi Emisoras, Inc. Todos los derechos reservados</p>
                </div>
            </div>
        </footer>
    )
